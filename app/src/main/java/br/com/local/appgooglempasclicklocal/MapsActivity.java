package br.com.local.appgooglempasclicklocal;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng etecia = new LatLng(-23.702497037277233, -46.689319917744655);
        //-23.702497037277233, -46.689319917744655
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                mMap.addMarker(new MarkerOptions()
                        .position(latLng)
                        .title("Clique curto!!!")
                        .snippet("Descrição do local com clique curto!!!")
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                Toast.makeText(MapsActivity.this,
                        "Clique Longo - Lat: " + latitute + "Lon: " + longitude,
                        Toast.LENGTH_SHORT).show();
                ...
                mMap.addMarker(new MarkerOptions()
                        .position(latLng)
                        .title("Clique longo!!!")
                        .snippet("Descrição do local do clique longo")
